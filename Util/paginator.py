...
class Simple(discord.ui.View):
    def __init__(self, channel: discord.TextChannel, *, timeout: int = None, 
                 ...
                 LastEmbedButton: discord.ui.Button = discord.ui.Button(emoji="<:Shello_FarRight:1164269635353460897>", style=discord.ButtonStyle.grey),
    ...
    async def next_button_callback(self, interaction: discord.Interaction):
        if interaction.user.id != self.ctx.author.id:
            ...
            embed.set_footer(text=f"Shello - 2023")
